...
const muscleTemplates: Record<WorkoutDayNumber, WorkoutTemplate> = {
  1: {
    ...
    exercises: [
      { name: "Clean", prescription: "5 per side" },
      { name: "Strict press", prescription: "6 per side" },
      { name: "Front squat", prescription: "6 per side" },
      { name: "Bent-over row", prescription: "8 per side" },
      { name: "2-hand swing", prescription: "10" },
    ],
  ...
  2: {
    ...
    exercises: [
      { name: "2-hand swing", prescription: "15" },
      { name: "Clean", prescription: "5 per side" },
      { name: "Push press", prescription: "5 per side" },
      { name: "Reverse lunge in rack", prescription: "6 each leg" },
    ],
  ...
  3: {
    ...
    exercises: [
      { name: "Clean", prescription: "4 per side" },
      { name: "Strict press", prescription: "5 per side" },
      { name: "Front squat", prescription: "5 per side" },
      { name: "Bent-over row", prescription: "8 per side" },
      { name: "2-hand swing", prescription: "12" },
    ],
    baseRounds: rangeRounds(4, 6),
    baseRest: rest(90, 150),
  },
  4: {
    ...
    focus: "Crisp power",
    exercises: [
      { name: "High pull or snatch", prescription: "5 per side" },
      { name: "Clean", prescription: "4 per side" },
      { name: "Push press", prescription: "5 per side" },
      { name: "Front squat", prescription: "6 per side" },
      { name: "2-hand swing", prescription: "10" },
...
const fatLossTemplates: Record<WorkoutDayNumber, WorkoutTemplate> = {
  1: {
    ...
    exercises: [
      ...
      { name: "Front squat", prescription: "5 per side" },
      { name: "Push press", prescription: "5 per side" },
      { name: "Reverse lunge", prescription: "5 each leg" },
      { name: "2-hand swing", prescription: "15" },
    ],
    baseRounds: rangeRounds(4, 6),
    baseRest: rest(60, 90),
  ...
  2: {
    ...
    exercises: [
      { name: "Clean", prescription: "5 per side" },
      { name: "Bent-over row", prescription: "6 per side" },
      { name: "Strict press", prescription: "4 per side" },
      { name: "Front-rack march", prescription: "20 steps" },
      { name: "2-hand swing", prescription: "15" },
    ],
    baseRounds: rangeRounds(4, 5),
    baseRest: rest(60, 75),
  ...
  3: {
    ...
    exercises: [
      { name: "High pull or snatch", prescription: "5 per side" },
      { name: "Front squat", prescription: "6 per side" },
      { name: "Push press", prescription: "4 per side" },
      { name: "Bent-over row", prescription: "6 per side" },
      { name: "2-hand swing", prescription: "12" },
    ],
    baseRounds: rangeRounds(4, 6),
  ...
  4: {
    ...
    exercises: [
      { name: "Clean", prescription: "4 per side" },
      { name: "Push press", prescription: "4 per side" },
      { name: "Front squat", prescription: "4 per side" },
      { name: "Reverse lunge", prescription: "4 each leg" },
      { name: "Row", prescription: "6 per side" },
      { name: "2-hand swing", prescription: "20" },
    ],
